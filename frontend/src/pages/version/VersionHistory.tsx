...
import { Card, Timeline, Button, Tag, Typography, Space, Modal, message } from 'antd';
...
export function VersionHistory({ versions, onRestore, onDiff }: VersionHistoryProps) {
  ...
  const handleCompare = () => {
    if (selectedVersions.length === 2 && onDiff) {
      onDiff(selectedVersions[0], selectedVersions[1]);
    }
  };
